    ...
    <body>
        ...
        echo '<p>Correos: saulas73@educastur.es (admin) // saulalsafp@gmail.com</p>';
            ...
            try {
                ...
                $resultado=$bd->prepare("SELECT * FROM dbname_dbo_Act1_Ej1 WHERE usuario=? AND contraseña=?");
                $resultado->execute(array($email,$pass));
            ...
            if($array['nivel']=="0"){
                ...
                echo"<a href='/Tema5/Actividad01/principal05010231.php'><button type='submit'>ACCEDER</button></a>";
