    ...
    <body>
        ...
        <?php               
            if($_SESSION["nivel"]=="2"){
                ...
                echo("<form method='POST' action='ficheros05010131.php' enctype='multipart/form-data'>
                <div>
                <p>Archivo a subir:</p>
                ...
                echo("<br><a href='/Tema5/Actividad01/logout05010131.php'><button type='submit'>Logout</button></a>");
            }
